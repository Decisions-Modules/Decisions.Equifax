...
namespace Decisions.Equifax.PreQualificationOfOne.Response
{
        ...
        public class PreQualificationOfOneResponse
        {
            ...
            [JsonProperty("consumers")] public Consumers Consumers { get; set; }
        }
        ...
        public class EquifaxUsConsumerCreditReport
        {
            ...
            [JsonProperty("fraudVictimIndicator")] public FraudVictimIndicator FraudVictimIndicator { get; set; }
        ...
        public class AddressElement
        {
            ...
            [JsonProperty("streetType")] public string StreetType { get; set; }

            [JsonProperty("cityName")] public string CityName { get; set; }

            [JsonProperty("stateAbbreviation")] public string StateAbbreviation { get; set; }
            ...
            [JsonProperty("dateFirstReported")] public string DateFirstReported { get; set; }

            [JsonProperty("dateLastReported")] public string DateLastReported { get; set; }
        ...
        [DataContract]
        [Writable]
        public class FraudVictimIndicator
        {
        ...
        {
            [JsonProperty("alertType")] public FraudVictimIndicator AlertType { get; set; }

            [JsonProperty("dateReported")] public string DateReported { get; set; }

            [JsonProperty("effectiveDate")] public string EffectiveDate { get; set; }

            [JsonProperty("telephoneNumbers")] public TelephoneNumberElement[] TelephoneNumbers { get; set; }
        }
        ...
        {
            [JsonProperty("telephoneNumberType")] public FraudVictimIndicator TelephoneNumberType { get; set; }
        ...
        [DataContract]
        [Writable]
        public class AlternateDataSources
        {
        ...
        [DataContract]
        [Writable]
        public class FraudIqSyntheticIdv2Alerts
        {
            [JsonProperty("nonRegulatedIdentifier")]
            public string NonRegulatedIdentifier { get; set; }

            [JsonProperty("hitNohitIndicator")] public long HitNohitIndicator { get; set; }

            [JsonProperty("syntheticIdVer2")] public string SyntheticIdVer2 { get; set; }
        }
        ...
        {
            [JsonProperty("regulatedIdentifier")] public string RegulatedIdentifier { get; set; }
        ...
        [DataContract]
        [Writable]
        public class EquifaxUsConsumerCreditReportAttribute
        {
            [JsonProperty("modelNumber")] public string ModelNumber { get; set; }

            [JsonProperty("attributes")] public AttributeAttribute[] Attributes { get; set; }
        }
        ...
        public class Bankruptcy
        {
            ...
            [JsonProperty("filer")] public string Filer { get; set; }

            [JsonProperty("industryCode")] public string IndustryCode { get; set; }

            [JsonProperty("currentIntentOrDispositionCode")]
            [JsonConverter(typeof(FraudVictimIndicatorDataConverter))]
            public FraudVictimIndicator CurrentIntentOrDispositionCode { get; set; }

            [JsonProperty("dispositionDate")] public string DispositionDate { get; set; }

            [JsonProperty("dateFiled")] public string DateFiled { get; set; }
        ...
        public class Collection
        {
            ...
            [JsonProperty("clientNameOrNumber")] public string ClientNameOrNumber { get; set; }

            [JsonProperty("statusCode")]
            [JsonConverter(typeof(FraudVictimIndicatorDataConverter))]
            public FraudVictimIndicator StatusCode { get; set; }

            [JsonProperty("narrativeCodes")] public FraudVictimIndicator[] NarrativeCodes { get; set; }

            [JsonProperty("rawNarrativeCodes")] public string[] RawNarrativeCodes { get; set; }

            [JsonProperty("indicator")] public string Indicator { get; set; }

            [JsonProperty("dateReported")] public string DateReported { get; set; }

            [JsonProperty("dateAssigned")] public string DateAssigned { get; set; }

            [JsonProperty("originalAmount")] public long OriginalAmount { get; set; }
        ...
        {
            [JsonProperty("bureauCode")] public long BureauCode { get; set; }

            [JsonProperty("bureauName")] public string BureauName { get; set; }

            [JsonProperty("address")] public ConsumerReferralLocationAddress Address { get; set; }
        ...
        public class Identification
        {
            ...
            [JsonProperty("socialNumConfirmed")] public string SocialNumConfirmed { get; set; }

            [JsonProperty("socialMatchFlags")] public string SocialMatchFlags { get; set; }

            [JsonProperty("inquirySocialNum")] public long InquirySocialNum { get; set; }
            ...
            [JsonProperty("socialNumMatch")] public string SocialNumMatch { get; set; }
        }
        ...
        public class Inquiry
        {
            ...
            [JsonProperty("inquiryDate")] public string InquiryDate { get; set; }
        ...
        public class Model
        {
            ...
            [JsonProperty("reasons")] public ScoreNumberOrMarketMaxIndustryCode[] Reasons { get; set; }

            [JsonProperty("inquiryKeyFactor")] public FraudVictimIndicator InquiryKeyFactor { get; set; }
            ...
            [JsonProperty("modelIDOrScorecard")] public long? ModelIdOrScorecard { get; set; }
        ...
        public class RiskBasedPricingOrModel
        {
            ...
            [JsonProperty("lowRange")] public long LowRange { get; set; }

            [JsonProperty("highRange")] public long HighRange { get; set; }
        }
        ...
        {
            [JsonProperty("firstNameMatchFlag")] public string FirstNameMatchFlag { get; set; }

            [JsonProperty("lastNameMatchFlag")] public string LastNameMatchFlag { get; set; }

            [JsonProperty("middleNameMatchFlag")] public string MiddleNameMatchFlag { get; set; }
        }

        [DataContract]
        [Writable]
        public class OfacAlert
        {
            [JsonProperty("revisedLegalVerbiageIndicator")]
            public long RevisedLegalVerbiageIndicator { get; set; }

            [JsonProperty("memberFirmCode")] public string MemberFirmCode { get; set; }

            [JsonProperty("cdcTransactionDate")] public string CdcTransactionDate { get; set; }

            [JsonProperty("cdcTransactionTime")] public long CdcTransactionTime { get; set; }

            [JsonProperty("transactionType")] public string TransactionType { get; set; }

            [JsonProperty("cdcResponseCode")] public string CdcResponseCode { get; set; }

            [JsonProperty("legalVerbiage")] public string LegalVerbiage { get; set; }

            [JsonProperty("dataSegmentRegulated")] public string DataSegmentRegulated { get; set; }
        }

        [DataContract]
        [Writable]
        public class OnlineGeoCode
        {
            [JsonProperty("streetNumber")] public long StreetNumber { get; set; }
        ...
        public class Trade
        {
            ...
            [JsonProperty("monthsReviewed")] public string MonthsReviewed { get; set; }
            ...
            [JsonProperty("dateOpened")] public string DateOpened { get; set; }

            [JsonProperty("highCredit")] public long? HighCredit { get; set; }

            [JsonProperty("balance")] public long? Balance { get; set; }

            [JsonProperty("pastDueAmount")] public long? PastDueAmount { get; set; }
            ...
            [JsonProperty("lastPaymentDate")] public string LastPaymentDate { get; set; }
            ...
            [JsonProperty("paymentHistory1to24")] public string PaymentHistory1To24 { get; set; }

            [JsonProperty("thirtyDayCounter")] public long? ThirtyDayCounter { get; set; }

            [JsonProperty("sixtyDayCounter")] public long? SixtyDayCounter { get; set; }

            [JsonProperty("ninetyDayCounter")] public long? NinetyDayCounter { get; set; }

            [JsonProperty("previousHighRate1")] public long? PreviousHighRate1 { get; set; }

            [JsonProperty("previousHighDate1")] public string PreviousHighDate1 { get; set; }

            [JsonProperty("previousHighRate2")] public long? PreviousHighRate2 { get; set; }

            [JsonProperty("previousHighDate2")] public string PreviousHighDate2 { get; set; }

            [JsonProperty("previousHighRate3")] public long? PreviousHighRate3 { get; set; }

            [JsonProperty("previousHighDate3")] public string PreviousHighDate3 { get; set; }
